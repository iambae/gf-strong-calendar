...
import {
    Row, Col, ButtonToolbar, ToggleButton, ToggleButtonGroup,
    Navbar,
    Nav,
    NavItem,
    Button,
...
class TypeTableFilter extends React.Component {
	                ...
	                <Navbar.Collapse id="basic-navbar-nav">
	                    <Nav>
	                        <NavDropdown
	                            ...
	                            <NavDropdown.Item eventKey="typeCode">
									Type Code
	                            </NavDropdown.Item>
	                            <NavDropdown.Item eventKey="description">
									Description
	                            </NavDropdown.Item>
